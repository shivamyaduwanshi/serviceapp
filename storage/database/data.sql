...
INSERT INTO `<<prefix>>advertising` (`id`, `integration`, `is_responsive`, `slug`, `provider_name`, `description`, `tracking_code_large`, `tracking_code_medium`, `tracking_code_small`, `active`) VALUES
...
INSERT INTO `<<prefix>>packages` (`id`, `translation_lang`, `translation_of`, `name`, `short_name`, `ribbon`, `has_badge`, `price`, `currency_code`, `promo_duration`, `duration`, `pictures_limit`, `description`, `facebook_ads_duration`, `google_ads_duration`, `twitter_ads_duration`, `linkedin_ads_duration`, `recommended`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES
(1, 'en', 1, 'Regular List', 'Free', 'red', 1, '0.00', 'USD', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 2, 3, 0, 1),
(2, 'en', 2, 'Top page Ad', 'Premium', 'orange', 1, '7.50', 'USD', 7, 60, 10, 'Featured on the homepage\r\nFeatured in the category', 0, 0, 0, 0, 1, 0, 4, 5, 0, 1),
